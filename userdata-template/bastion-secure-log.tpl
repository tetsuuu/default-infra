...
# set up td-agent
aws s3 cp s3://${resource_s3_bucket}/terraform/resource/maintenance/bastion-secure-log/td-agent.repo /etc/yum.repos.d/
yum -y install td-agent
td-agent-gem install fluent-plugin-forest
aws s3 cp s3://${resource_s3_bucket}/terraform/resource/maintenance/bastion-secure-log/td-agent /etc/init.d/
...
aws s3 cp s3://${resource_s3_bucket}/terraform/resource/maintenance/bastion-secure-log/logfile_purge.sh /var/lib/td-agent/
...
aws s3 cp s3://${resource_s3_bucket}/terraform/resource/maintenance/bastion-secure-log/cron.update-td-agent /etc/cron.d/
chown root:root /etc/cron.d/cron.update-td-agent
chmod 644 /etc/cron.d/cron.update-td-agent

# bastion
aws s3 cp s3://${resource_s3_bucket}/terraform/resource/maintenance/bastion-secure-log/audit_logger /usr/local/bin/
...
# set up sssd
aws s3 cp s3://${resource_s3_bucket}/terraform/resource/maintenance/bastion-secure-log/sssd.conf /etc/sssd/sssd.conf
...
aws s3 cp s3://${resource_s3_bucket}/terraform/resource/maintenance/bastion-secure-log/create_log_dir.sh /var/lib/td-agent/
...
# TODO add nrpe setup after nagios enabling
